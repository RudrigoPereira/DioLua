...
-- local ansicolorx = require 'libs.ansicolorsx'

-- print(ansicolorx '%{italic red}An italic text with red color!')
-- print(ansicolorx '%{bbluebg cyan}A text with bright blue background and cyan foreground color!')