...
function actions.build()
    ...
    local swordAttack = {
        ...
        execute = function (playerData, creatureData)
            ...
            if success then
                ...
                print(string.format("O ataque de %s falhou... com sucesso!", playerData.name))
            end
        end
    }
    ...
    local regenPotion = {
        ...
        execute = function (playerData, creatureData)
            ...
            print(string.format("%s: %s", creatureData.name, utils.getProgressbar((creatureData.health / creatureData.maxHealth) * 10)))
        end
    }
